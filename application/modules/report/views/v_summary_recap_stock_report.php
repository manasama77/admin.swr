...
<script type="text/javascript">
    ...
    function get_report() {
        ...
        if ((startperiod == "") || (endperiod == "")) {
            ...
            $.ajax({
                type: 'GET',
                datatype: 'JSON',
                url: '<?php echo site_url() ?>report/summary_recap_stock_report/get_report',
                data: {
                ...
                success: function(data) {
                    ...
                    $.each(obj, function(i, item) {
                        ...
                        if (itemcodeold != itemcodenew) {
                            ...
                            html += '<tr>' +
                                '<td style="text-align:left;" colspan="7"><strong>Kategori Barang : ' + item.stock_category_name + ' / Jenis Barang : (' + item.barcode + ') ' + item.item_name + '</strong></td>' +
                                '</tr>';
    ...
    function get_print() {
        ...
        if ((startperiod == "") || (endperiod == "")) {
            ...
            var win = window.open('<?php echo site_url() ?>report/summary_recap_stock_report/get_print/' + from_period + '/' + to_period + '/' + branchid + '/' + itemid, '_blank');
            if (win) {
    ...
    function get_excel() {
        ...
        if ((startperiod == "") || (endperiod == "")) {
            ...
            var win = window.open('<?php echo site_url() ?>report/summary_recap_stock_report/get_excel/' + from_period + '/' + to_period + '/' + branchid + '/' + itemid, '_blank');
            if (win) {
                //Browser has allowed it to be opened
                win.focus();
            } else {
