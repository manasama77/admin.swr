...
<form class="form-horizontal" id="formpage" action="<?php echo site_url('master/stock_item/create_post'); ?>" method="post">
            ...
            <div class="box-body">
                <div class="row">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Supplier<font color="red">*</font></label>
                            <div class="col-sm-4">
                                <select class="form-control select2" id="supplierid" name="supplierid" style="width: 100%;">
                                <?php foreach($supplier->result() as $row) :?>
                                    <?php echo "<option value='". $row->supplier_id . "'>" . $row->supplier_name . "</option>"; ?>
                                <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php foreach($stockcategory->result() as $row) :?>
                                    <?php echo "<option value='". $row->stock_category_id . "'>" . $row->stock_category_name . "</option>"; ?>
                                <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control select2" id="stockunitid" name="stockunitid" style="width: 100%;">
                                <?php foreach($stockunit->result() as $row) :?>
                                    <?php echo "<option value='". $row->unit_id . "'>" . $row->unit_name . "</option>"; ?>
                                <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="itemcode" name="itemcode" value="<?php echo $itemcode->itemcode; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="0" id="minimumstock" name="minimumstock" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Maximum Stock<font color="red">*</font></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="0" id="maximumstock" name="maximumstock" required>
                            </div>
                        </div>
                </div>
            </div>
