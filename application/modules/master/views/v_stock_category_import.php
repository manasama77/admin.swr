...
<form class="form-horizontal" id="formpage" action="<?php echo site_url('master/stock_category/import_post'); ?>" method="post">
				...
				<tbody>
					 <?php foreach($data_excell as $row=>$innerArray) :?>
						<tr>
							...
							<td><?php echo $innerArray['stockcategoryname']; ?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
