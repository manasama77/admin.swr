            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" id="existingpass" name="existingpass">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function save_data()
    {
        var frm = $('#form');
        $.ajax({
            url : "<?php echo site_url() ?>home/update_password",
            type: "POST",
            data: frm.serialize(),
            dataType: "JSON",
            success: function(data)
            {
                ...
                {
                    $("#WarningContent").replaceWith("<div id='WarningContent'>" + data.message + "</div>");
